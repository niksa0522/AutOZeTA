...
public class ZakazaniTerminiRecyclerViewAdapter extends RecyclerView.Adapter<ZakazaniTerminiRecyclerViewAdapter.ZakazaniTerminViewHolder>{
    ...
    public ZakazaniTerminiRecyclerViewAdapter(List<ZakazanTermin> terminiList,List<String> terminIDlist) {
        this.terminiList=terminiList;
        this.terminIDlist=terminIDlist;
    }
    @NonNull
    @Override
    public ZakazaniTerminViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.zakazan_termin_list_item, parent, false);
        return new ZakazaniTerminiRecyclerViewAdapter.ZakazaniTerminViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ZakazaniTerminViewHolder holder, int position) {
        final String usersIDs = terminiList.get(position).getWorkshopId();
                ...
                if(snapshot.exists())
                {
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent terminIntent = new Intent(holder.itemView.getContext(), ZakazanTerminActivity.class);
