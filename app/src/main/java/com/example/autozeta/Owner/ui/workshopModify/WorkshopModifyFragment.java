package com.example.autozeta.Owner.ui.workshopModify;
...
import com.example.autozeta.LoginAndRegistration.WorkshopRegActivity;
import com.example.autozeta.LoginAndRegistration.WorkshopRegMainFragment;
...
public class WorkshopModifyFragment extends Fragment {
    ...
    Button btnServices,btnMonFri,btnSat,btnSun,btnAddress,btnFinish;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        btnFinish.setText("Azuriraj Radionicu");
            ...
            public void onClick(View v) {
                ...
                if(priv.getName().isEmpty() || priv.getName().equals("")){
                    ...
                    Workshop toSend = priv;
                        ...
                        Toast.makeText(getActivity(),"Azuriranje uspesno",Toast.LENGTH_SHORT).show();
    ...
    private void SetData(){
        ...
        List<WorkDaysAndHours> wdList =  new ArrayList<>();
        wdList.add(MF);
        wdList.add(Saturday);
        wdList.add(Sunday);
        priv.setWorkDays(wdList);
    ...
    private void getLocation(){
        if(ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED
            ...
            if(loc!=null){
                ...
                NavHostFragment.findNavController(WorkshopModifyFragment.this)
                        .navigate(R.id.action_nav_modify_to_mapsWorkshopChooserFragment,bundle);
            }
            else {
                getCurrentLocation();
            }
